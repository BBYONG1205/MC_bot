...
cred = credentials.Certificate('./calculatebot-667f4-firebase-adminsdk-30usx-c85f2ae690.json')
...
def 정산요청상세_불러오기(요청자):
    ...
    if doc.exists:
        ...
        셜커_리스트 = [셜커.get('셜커','내역없음') for 셜커 in 품목_목록]
        return 품목명_리스트, 금액_리스트 , 세트_리스트, 셜커_리스트
    else:
